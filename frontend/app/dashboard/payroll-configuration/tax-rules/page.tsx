        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-700 to-gray-700 bg-clip-text text-transparent">Tax Rules</h1>
          ...
          {isLegalAdmin && (
            <button
              ...
              className="group relative px-6 py-3 bg-gradient-to-r from-slate-600 to-gray-700 text-white text-sm font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-slate-700 hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all duration-200 flex items-center transform hover:scale-105"
            >
